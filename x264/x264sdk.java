...
public class x264sdk {
	...
	{
		void h264data(byte[] buffer, int length, long timestamp);
	}
	...
	private void H264DataCallBackFunc(byte[] buffer, int length, long timestamp){
		_listener.h264data(buffer, length, timestamp);
	}
